...
"color: #fff;")
    ...
    def retranslateUi(self, Main):
        ...
        self.logo.setText("")
        self.nombre.setText(QCoreApplication.translate("Main", u"Personal Organizer DL", None))
        self.label_input_dir.setText(QCoreApplication.translate("Main", u"Directory:", None))
        self.input_dir.setText(QCoreApplication.translate("Main", u"", None))
        self.select_dir.setText(QCoreApplication.translate("Main", u"...", None))
        self.label_select_filter.setText(QCoreApplication.translate("Main", u"Select Filter:", None))
        self.organize_btn.setText(QCoreApplication.translate("Main", u"Organize", None))
        self.back_btn.setText(QCoreApplication.translate("Main", u"...", None))
        self.label.setText(QCoreApplication.translate("Main", u"Filters:", None))
        self.edit_btn.setText(QCoreApplication.translate("Main", u"Edit", None))
        self.delete_btn.setText(QCoreApplication.translate("Main", u"Delete", None))
        self.text_title.setText(QCoreApplication.translate("Main", u"Create New Filter", None))
        self.name_label.setText(QCoreApplication.translate("Main", u"Name", None))
        self.dir_label.setText(QCoreApplication.translate("Main", u"Directory", None))
        self.dir_select_btn.setText(QCoreApplication.translate("Main", u"...", None))
        self.add_extension_label.setText(QCoreApplication.translate("Main", u"Add Extension", None))
        self.add_extension_btn.setText(QCoreApplication.translate("Main", u"+", None))
        self.extensions_list_label.setText(QCoreApplication.translate("Main", u"Adding Extensions", None))
        self.create_filter.setText(QCoreApplication.translate("Main", u"Create", None))
    # retranslateUi
